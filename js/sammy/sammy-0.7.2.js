...
$.extend(Sammy.DefaultLocationProxy.prototype , {
  ...
  Sammy.Application.prototype = $.extend({}, Sammy.Object.prototype, {
    ...
    _checkLocation: function() {
      ...
      location = decodeURIComponent(this.getLocation()); // AMKT-4682
  ...
  Sammy.RenderContext.prototype = $.extend({}, Sammy.Object.prototype, {
    ...
    load: function(location, options, callback) {
      ...
      return this.then(function() {
        var should_cache, cached, is_json, is_jsonp, location_array, loading;
        if (_isFunction(options)) {
          callback = options;
          options = {};
        } else {
        ...
        if (typeof location === 'string') {
          ...
          is_jsonp     = options.jsonp;
          loading      = options.loading;
          should_cache = is_json || is_jsonp ? options.cache === true : options.cache !== false;
          ...
          $.ajax($.extend({
            url: location,
            data: {},
            dataType: is_json ? 'json' : is_jsonp ? 'jsonp' : 'text',
            type: 'get',
